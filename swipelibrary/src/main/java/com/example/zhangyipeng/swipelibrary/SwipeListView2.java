...
public class SwipeListView2 extends ListView {
    ...
    */
     ...
     */
    private SwipeListViewTouchListener2 touchListener;
     ...
     */
    public SwipeListView2(Context context, int swipeBackView, int swipeFrontView) {
        super(context);
    ...
    private void init(AttributeSet attrs) {
        ...
        touchSlop = ViewConfigurationCompat.getScaledPagingTouchSlop(configuration);//滑动参数
        touchListener = new SwipeListViewTouchListener2(this, swipeFrontView, swipeBackView);
