...
public class SwipeRecycleView extends RecyclerView {
     ...
     * log tag
    */
    public final static String TAG = "SwipeRecycleView";
    ...
    */
     ...
     */
    private SwipeRecycleViewTouchListener touchListener;
     ...
     */
    public SwipeRecycleView(Context context, int swipeBackView, int swipeFrontView) {
        super(context);
    ...
    private void init(AttributeSet attrs) {
        ...
        touchListener = new SwipeRecycleViewTouchListener(this, swipeFrontView, swipeBackView);
